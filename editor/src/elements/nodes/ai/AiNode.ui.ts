...
export const aiNodeUi: NodeUi = {
  ...
  generation: {
    ...fromEngine(new AiNode().generation()),
  ...
  Panel: lazy(() => import('./AiNodePanel')),
  AdvancedPanel: lazy(() => import('./AiNodeAdvancedPanel')),
  advancedSummary: 'model, tools, batching, failures',
  create: (id) => ({
    id,
    node_type: 'ai',
    label: 'AI Node',
