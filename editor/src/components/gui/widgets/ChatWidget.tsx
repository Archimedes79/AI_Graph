 ...
 * engine's `ChatElement.settle`), which also empties `pending`. A run that
 * fails leaves it, so the message is still in the box to send again.
 */
export default function ChatWidget({ value, onChange, onTrigger, busy }: GuiWidgetRuntimeProps) {
