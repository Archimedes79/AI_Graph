...
async def generate_graph(
    ...
    system = (
        ...
        "gui. There is no dedicated merge/split node type: fan-in (multiple edges into one "
        ...
        "(shows the result in a text window); \"text_output\" is accepted only as a legacy "
        "alias for that. "
