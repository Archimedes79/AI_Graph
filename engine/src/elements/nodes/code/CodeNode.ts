...
const CODE_FIELDS: LogicFields = { body: 'code', prompt: 'code_prompt', file: 'code_file' };
 ...
 */
export class CodeNode extends GraphNodeElement<CodeConfig> {
  ...
  override logic(node: GraphNode): Logic {
    return logicFrom(node, 'code', CODE_FIELDS, "this node's code");
  }
