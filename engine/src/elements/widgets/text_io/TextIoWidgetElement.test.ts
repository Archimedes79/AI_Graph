...
import { TextIoWidgetElement } from './TextIoWidgetElement.ts';
 ...
 *
 * The rule used to live in the editor's `WidgetUi`, which meant the one store
 ...
 */
const element = new TextIoWidgetElement();
