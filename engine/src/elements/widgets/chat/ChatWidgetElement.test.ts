...
import { ChatWidgetElement, transcript } from './ChatWidgetElement.ts';
import { parseWidget } from '../../nodes/gui/GuiNodeElement.ts';
import { executeGraph } from '../../../execution/executor.ts';
import { registry } from '../../registry.ts';
import { parseGraph } from '../../../graph.ts';
import type { AiRequest, Runtime } from '../../Runtime.ts';

const chat = new ChatWidgetElement();

describe('ChatWidgetElement', () => {
